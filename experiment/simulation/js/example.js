	...
	if($.browser.msie) {
		...
		//demultiplexer
		{
			...
			$("#clear_button_enc").click(function() {
				...
				for(var i = 0; i <= 2; i++) {
					document.getElementById("encoder" + i).src = "images/lightbulbleft.png";
			...
			$("#clear_button_dec").click(function() {
				...
				for(var i = 0; i <= 7; i++) {
					document.getElementById("decoder" + i).src = "images/lightbulbleft.png";
					location.reload();
			...
			$("#clear_button_demux").click(function() {
				...
				for(var k = 0; k <= 7; k++) {
					document.getElementById("demul" + k).src = "images/lightbulbleft.png";
